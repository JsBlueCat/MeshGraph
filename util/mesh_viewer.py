...
if __name__ == '__main__':
    ...
    parser.add_argument('--files', nargs='+', default=['/meshgraph/ckpt_root/airplane_0124.obj',
                                                       #'/meshgraph/ckpt_root/bed_0010.obj',
                                                       #'/meshgraph/ckpt_root/cup_0007.obj',
                                                       #'/meshgraph/ckpt_root/person_0004.obj',
                                                       #'/meshgraph/ckpt_root/toilet_0006.obj',
                                                       #'/meshgraph/ckpt_root/tv_stand_0004.obj',
                                                       #'/meshgraph/ckpt_root/xbox_0005.obj'
                                                       ], type=str,
